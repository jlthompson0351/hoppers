...
class JobCompletionWebhookTests(unittest.TestCase):
    ...
    def test_transition_enqueues_summary_payload(self) -> None:
        ...
        self.assertFalse(bool(payload["anomaly_detected"]))
        self.assertEqual(payload["first_basket_dump_utc"], "2026-03-05T12:01:30+00:00")
        self.assertEqual(payload["last_basket_dump_utc"], "2026-03-05T12:02:30+00:00")
        self.assertIsInstance(payload["idle_gaps"], list)
        self.assertIsInstance(payload["hopper_load_times"], list)
